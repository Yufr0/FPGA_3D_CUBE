...
HD_PWD='C:/Users/yufei/Desktop/VGA_RAM_try1/VGA_RAM_try1.runs/cordic_sin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_sin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_sin.tcl
