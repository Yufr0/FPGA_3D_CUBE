...
HD_PWD='D:/codehub/VIVADO/VGA_RAM_try2/VGA_RAM_try1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_RAM.tcl -notrace
