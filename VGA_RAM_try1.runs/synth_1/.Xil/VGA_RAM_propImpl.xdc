set_property SRC_FILE_INFO {cfile:{D:/codehub/VIVADO/VGA_RAM_try1/VGA_RAM_try1.srcs/constrs_1/new/Nexys4 ddr.xdc} rfile:{../../../VGA_RAM_try1.srcs/constrs_1/new/Nexys4 ddr.xdc} id:1} [current_design]
...
set_property -dict { PACKAGE_PIN B3    IOSTANDARD LVCMOS33 } [get_ports { RST_BTN }]; #IO_L10P_T1_AD15P_35 Sch=eth_rstn
